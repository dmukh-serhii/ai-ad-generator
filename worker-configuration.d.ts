/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 56f60d0860ff6698383e234d7dfaee77)
// Runtime types generated with workerd@1.20260701.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BROWSER: BrowserRun;
	PUBLIC_USER_ID: "u-test-0001";
	PUBLIC_LIMIT_PER_HOUR: "12";
	GEMINI_MODEL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_USER_ID" | "PUBLIC_LIMIT_PER_HOUR" | "GEMINI_MODEL" | "GEMINI_API_KEY">> {}
}
